          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                <li class="{{ ($title === 'Home') ? 'active' : '' }}"><a href="{{route('home')}}">Home <span class="sr-only">(current)</span></a></li>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li class="{{ ($title === 'Tampil Santri') ? 'active' : '' }}"><a href="{{ route('tampilsantri') }}">Tampil Santri</a></li>
                  </ul>
                </li>
              </ul>
